            ...
            overlay={
                <Tooltip>
                    <div className="tooltip-club-content">
                        ...
                        <div>{team?.player1?.club || DATA.NC}</div>
                    </div>
                    <div className="tooltip-phone-content">
                        <div className="bi bi-telephone tooltip-icon"></div>
                        <div>{team?.player1?.phoneNumber || DATA.NC}</div>
                    </div>
                    <div className="tooltip-mail-content">
                        <div className="bi bi-envelope tooltip-icon"></div>
                        <div>{team?.player1?.email || DATA.NC}</div>
                    </div>
                    <div className="tooltip-club-content">
                        <div className="bi bi-house tooltip-icon"></div>
                        <div>{team?.player2?.club || DATA.NC}</div>
                    </div>
                    <div className="tooltip-phone-content">
                        <div className="bi bi-telephone tooltip-icon"></div>
                        <div>{team?.player2?.phoneNumber || DATA.NC}</div>
                    </div>
                    <div className="tooltip-mail-content">
                        <div className="bi bi-envelope tooltip-icon"></div>
                        <div>{team?.player2?.email || DATA.NC}</div>
                    </div>
                </Tooltip>
            }
        >
